Public Class CitadelClash
    ...
    'Arrays to hold the player names and wavesReached of the 5 players in the leaderboard
    'The arrrays have been set to initial values
    ...
    Private Sub GameLogic_Tick(sender As Object, e As EventArgs) Handles GameLogic.Tick
        ...
        'Players can click on the tower to access the UI, from their buy upgrades, In the UI the price for the next upgrade is displayed.
